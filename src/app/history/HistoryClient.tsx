      ...
      <div className="p-4 pt-0 space-y-4">
        {initialMovements.length === 0 ? (
          ...
          filteredMovements.map((movement) => (
            <div
                key={movement.id}
                className="rounded-2xl border border-border/60 bg-surface transition-colors transition-shadow hover:border-emerald-400 hover:bg-emerald-50/60 dark:bg-surface dark:hover:bg-emerald-500/5"
            >
                <CardHeader>
